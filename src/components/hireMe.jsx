...
const HireMe = () => {
  return (
    <div className="fixed bottom-0 flex items-center justify-center overflow-hidden left-4 md:right-[-30px] xs:right-[-40px]  md:left-auto md:top-[-15px] md:bottom-auto z-50">
